<?php
namespace EdgeCore\CPT\Shortcodes\Dropcaps;
...
class Dropcaps implements Lib\ShortcodeInterface
{
    ...
    public function render($atts, $content = null) {
        ...
        $html = edgtf_core_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
    ...
    private function getDropcapsClass($params) {
        return !empty($params['type']) ? 'edgtf-' . $params['type'] : '';
    }
}