<a itemprop="url" href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" <?php hyperon_edgtf_inline_style($button_styles); ?> <?php hyperon_edgtf_class_attribute($button_classes); ?> <?php echo hyperon_edgtf_get_inline_attrs($button_data); ?> <?php echo hyperon_edgtf_get_inline_attrs($button_custom_attrs); ?>>
