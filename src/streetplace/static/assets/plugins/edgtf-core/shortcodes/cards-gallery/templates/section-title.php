<?php
$button_params['link'] = $button_link;
$button_params['text'] = $button_text;
$button_params['color'] = $button_color;
$button_params['target'] = $button_target;
$button_params['type'] = $button_type;
?>
...
<div class="edgtf-section-title-holder">
    <div class="edgtf-st-inner">
        ...
        <?php if (!empty($button_link)): ?>
            <?php echo hyperon_edgtf_get_button_html($button_params); ?>
        <?php endif; ?>
