...
class CustomFont implements Lib\ShortcodeInterface
{
                ...
                array(
                    ...
                    'params' => array(
                        ...
                        array(
                            'type' => 'textfield',
                            'param_name' => 'title',
                            'heading' => esc_html__('Title Text', 'edgtf-core')
                        ),
                        array(
                            'type' => 'dropdown',
                            'param_name' => 'type_out_effect',
                            'heading' => esc_html__('Enable Type Out Effect', 'edgtf-core'),
                            'description' => esc_html__('Adds a type out effect inside custom font content', 'edgtf-core'),
                            'value' => array_flip(hyperon_edgtf_get_yes_no_select_array(false))
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'type_out_position',
                            'heading' => esc_html__('Position of Type Out Effect', 'edgtf-core'),
                            'description' => esc_html__('Enter the position of the word after which you would like to display type out effect (e.g. if you would like the type out effect after the 3rd word, you would enter "3")', 'edgtf-core'),
                            'dependency' => array('element' => 'type_out_effect', 'value' => array('yes'))
                        ),
                        array(
                            'type' => 'colorpicker',
                            'param_name' => 'typed_color',
                            'heading' => esc_html__('Typed Color', 'edgtf-core'),
                            'dependency' => array('element' => 'type_out_effect', 'value' => array('yes'))
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'typed_ending_1',
                            'heading' => esc_html__('Typed Ending Number 1', 'edgtf-core'),
                            'dependency' => Array('element' => 'type_out_effect', 'value' => array('yes'))
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'typed_ending_2',
                            'heading' => esc_html__('Typed Ending Number 2', 'edgtf-core'),
                            'dependency' => array('element' => 'typed_ending_1', 'not_empty' => true)
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'typed_ending_3',
                            'heading' => esc_html__('Typed Ending Number 3', 'edgtf-core'),
                            'dependency' => array('element' => 'typed_ending_2', 'not_empty' => true)
                        ),
                        array(
                            'type' => 'textfield',
                            'param_name' => 'typed_ending_4',
                            'heading' => esc_html__('Typed Ending Number 4', 'edgtf-core'),
                        ...
                        array(
                            ...
                            'description' => esc_html__('Enter the positions of the words after which you would like to create a line break (e.g. if you would like the line break after the 3rd and 8th words, you would enter "3,8")', 'edgtf-core'),
                        ...
                        array(
                            ...
                            'value' => array_flip(hyperon_edgtf_get_text_decorations(true)),
                            'save_always' => true
                        ),
                        array(
                            'type' => 'colorpicker',
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Font Size (px or em)', 'edgtf-core'),
                            'group' => esc_html__('Small Laptops', 'edgtf-core')
                        ),
                        array(
                            'type' => 'textfield',
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Font Size (px or em)', 'edgtf-core'),
                            'group' => esc_html__('Tablets Landscape', 'edgtf-core')
                        ),
                        array(
                            'type' => 'textfield',
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Font Size (px or em)', 'edgtf-core'),
                            'group' => esc_html__('Tablets Portrait', 'edgtf-core')
                        ),
                        array(
                            'type' => 'textfield',
                        ...
                        array(
                            ...
                            'heading' => esc_html__('Font Size (px or em)', 'edgtf-core'),
                            'group' => esc_html__('Mobiles', 'edgtf-core')
                        ),
                        array(
                            'type' => 'textfield',
    ...
    private function getHolderData($params) {
        ...
        if ($params['font_size_1280'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['font_size_1280'], 'px') || hyperon_edgtf_string_ends_with($params['font_size_1280'], 'em')) {
        ...
        if ($params['font_size_1024'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['font_size_1024'], 'px') || hyperon_edgtf_string_ends_with($params['font_size_1024'], 'em')) {
        ...
        if ($params['font_size_768'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['font_size_768'], 'px') || hyperon_edgtf_string_ends_with($params['font_size_768'], 'em')) {
        ...
        if ($params['font_size_680'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['font_size_680'], 'px') || hyperon_edgtf_string_ends_with($params['font_size_680'], 'em')) {
        ...
        if ($params['line_height_1280'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['line_height_1280'], 'px') || hyperon_edgtf_string_ends_with($params['line_height_1280'], 'em')) {
        ...
        if ($params['line_height_1024'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['line_height_1024'], 'px') || hyperon_edgtf_string_ends_with($params['line_height_1024'], 'em')) {
        ...
        if ($params['line_height_768'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['line_height_768'], 'px') || hyperon_edgtf_string_ends_with($params['line_height_768'], 'em')) {
        ...
        if ($params['line_height_680'] !== '') {
            if (hyperon_edgtf_string_ends_with($params['line_height_680'], 'px') || hyperon_edgtf_string_ends_with($params['line_height_680'], 'em')) {
    ...
    private function getModifiedTitle($params) {
        ...
        if (!empty($title) && ($type_out_effect === 'yes' || !empty($title_break_words))) {
            ...
            if ($type_out_effect === 'yes' && !empty($type_out_position)) {
                ...
                $typed_html = '<span class="edgtf-cf-typed-wrap" ' . hyperon_edgtf_get_inline_style($typed_styles) . '><span class="edgtf-cf-typed">';
