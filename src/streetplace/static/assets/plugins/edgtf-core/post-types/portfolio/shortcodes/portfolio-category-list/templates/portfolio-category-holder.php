<div class="edgtf-portfolio-category-list-holder <?php echo esc_attr($holder_classes); ?>">
    <div class="edgtf-pcl-inner edgtf-outer-space clearfix">
        ...
        if (!empty($query_results)) {
            foreach ($query_results as $query) {
                ...
                <article class="edgtf-pcl-item edgtf-item-space">
                    <div class="edgtf-pcl-item-inner">
                        <?php echo edgtf_core_get_cpt_shortcode_module_template_part('portfolio', 'portfolio-category-list', 'parts/image', '', $params); ?>
                        <div class="edgtf-pcli-text-holder">
                            <div class="edgtf-pcli-text-wrapper">
                                <div class="edgtf-pcli-text">
                                    <?php echo edgtf_core_get_cpt_shortcode_module_template_part('portfolio', 'portfolio-category-list', 'parts/title', '', $params); ?>
                                    <?php echo edgtf_core_get_cpt_shortcode_module_template_part('portfolio', 'portfolio-category-list', 'parts/excerpt', '', $params); ?>
                                </div>
                            </div>
                        </div>
            ...
            echo edgtf_core_get_cpt_shortcode_module_template_part('portfolio', 'portfolio-category-list', 'parts/posts-not-found', '', $params);
        }
        ?>
    </div>
</div>